    ...
    <div id="app">
        ...
        <div class="row">
            ...
            @if (\App\GroupPermission::usercan('view','chat'))
                ...
                {{-- <div class="hidden chat-sender-name">{{ Auth::user()->name }}</div> --}}
                ...
                <div id="chat-dom chat-ui-operator">
                    <div class="panel panel-primary chat-panel">

                        <div class="panel-heading " id="accordion">
                            <span class="glyphicon glyphicon-comment"></span> Chat
                            <span style="margin-left: 10px;"  id="operatorName">{{ Auth::user()->name }}</span>
                            <div class="btn-group pull-right">
                        ...
                        <div class="panel-collapse collapse" id="collapseOne">
                            ...
                            <div class="panel-body">
                                <ul class="inner-chatroom" id="inner-chatroom">
                                </ul>
                            </div>
