        ...
        <div class="panel-body">
            <form class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <p class="form-control-static">{{$contentType->name}}</p>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label">English name</label>
                    <div class="col-sm-10">
                        <p class="form-control-static">{{$contentType->display_name_en}}</p>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label">English description</label>
                    <div class="col-sm-10">
                        <p class="form-control-static">{{$contentType->description_en}}</p>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label">Greek name</label>
                    <div class="col-sm-10">
                        <p class="form-control-static">{{$contentType->display_name_gr}}</p>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label">Greek description</label>
                    <div class="col-sm-10">
                        <p class="form-control-static">{{$contentType->description_gr}}</p>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        <a href="{{route('contentType.index')}}" class="btn btn-primary">
