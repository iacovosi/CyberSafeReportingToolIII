        ...
        <div class="panel-body">
            ...
            <div class="table-responsive">
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        @if ($referenceBy) 
                        @foreach ($referenceBy as $key=>$item)
                            <tr>
                                <td>{{ ++$key }}</td>
                                {{--  <td>{{$item->id}}</td>  --}}
                                <td>{{$item->name}}</td>
                                ...
                                <td style='white-space: nowrap'>
                                    ...
                                    <form method="POST" action="/referenceBy/{{$item->id}}">
                                        {{--  Other actions are included in the form for styling purposes  --}}
                                        <a href="{{route('referenceBy.show', $item->id)}}" class="btn btn-default">
                                            <i class="fa fa-eye" aria-hidden="true"></i> Show
                                        </a>
                                        <a href="{{route('referenceBy.edit', $item->id)}}" class="btn btn-default">
