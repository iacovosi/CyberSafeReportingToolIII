...
<div class="container">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            --}}
            <form class="form-horizontal" method="POST" action="/referenceTo/{{$referenceTo->id}}">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="name" value="{{$referenceTo->name}}">
                    </div>
                </div>
                <div class="form-group">
                    <label for="display_name_en" class="col-sm-2 control-label">English name</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="display_name_en" value="{{$referenceTo->display_name_en}}">
                    </div>
                </div>
                <div class="form-group">
                    <label for="description_en" class="col-sm-2 control-label">English description</label>
                    <div class="col-sm-10">
                        <textarea class="form-control" rows="3" name="description_en">{{$referenceTo->description_en}}</textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label for="display_name_gr" class="col-sm-2 control-label">Greek name</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="display_name_gr" value="{{$referenceTo->display_name_gr}}">
                    </div>
                </div>
                <div class="form-group">
                    <label for="description_gr" class="col-sm-2 control-label">Greek description</label>
                    <div class="col-sm-10">
                            <textarea class="form-control" rows="3" name="description_gr">{{$referenceTo->description_gr}}</textarea>
                    </div>
                </div>                
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        ...
                        <a href="{{route('referenceTo.index')}}" class="btn btn-default">
